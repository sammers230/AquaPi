...
#H = input("Input water change time Hour as a two digit value Eg. 06 : ")
#M = input("Input water change time Minute as a two digit value Eg. 01 : ")
